c **** SUBROUTINES used by infrared transmittance models employing the
c                       PLOD/PFAAST algorithm 
c .... version of 18.03.03

c **** for SPACECRAFT at the 101 AIRS pressure levels
...
c * Byte-flip radiative-transfer coefficients
