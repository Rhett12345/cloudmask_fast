...
code_path = '/home/huxq/fy3cloud/fy3_mersi2_cloud/retrieval/'
	...
	if os.path.isdir(directory_name):
		...
		for filename in file_list:
			...
			if (len(file_geo)>0 and hour>=hour_lmt[0] and hour<=hour_lmt[1]):
				...
				fy3_mersi_CLM_data  = L2_path+date_fn+'/'+'FY3D_MERSI_GBAL_L2_'+date_fn+'_'+hm+'_CLMXX_MS.HDF'
				fy3_mersi_CPP_data  = L2_path+date_fn+'/'+'FY3D_MERSI_GBAL_L2_'+date_fn+'_'+hm+'_CPPXX_MS.HDF'
				fy3_mersi_CTP_data  = L2_path+date_fn+'/'+'FY3D_MERSI_GBAL_L2_'+date_fn+'_'+hm+'_CTPXX_MS.HDF'
				fy3_mersi_COP_data  = L2_path+date_fn+'/'+'FY3D_MERSI_GBAL_L2_'+date_fn+'_'+hm+'_COPXX_MS.HDF'
				fy3_mersi_CLD_data  = L2_path+date_fn+'/'+'FY3D_MERSI_GBAL_L2_'+date_fn+'_'+hm+'_CLDXX_MS.HDF'
				fy3_intermediate    = L2_path+date_fn+'/'+'FY3D_MERSI_GBAL_L2_'+date_fn+'_'+hm+'_INTERMED.HDF'
			...
			if (retr_id == 1):
				...
				f.write('  fy3_mersi_CPP_data  = "'+fy3_mersi_CPP_data+'",\n')
				f.write('  fy3_mersi_CTP_data  = "'+fy3_mersi_CTP_data+'",\n')
				f.write('  fy3_mersi_COP_data  = "'+fy3_mersi_COP_data+'",\n')
				f.write('  fy3_mersi_CLD_data  = "'+fy3_mersi_CLD_data+'",\n')
